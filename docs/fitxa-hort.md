<h1 id="-fitxa-del-meu-hort-osona">🏡 Fitxa del meu hort — Osona</h1>
<h2 id="dades-generals">Dades generals</h2>
<ul>
<li><strong>Ubicació</strong>: Osona, Catalunya</li>
<li><strong>Mida</strong>: ~20 m²</li>
<li><strong>Orientació</strong> <em>(a completar)</em>:</li>
<li><strong>Tipus de sòl</strong>: SORRENc (drena molt bé, però cal regar més sovint)</li>
<li><strong>Altitud</strong> <em>(a completar)</em>:</li>
<li><strong>Inicialització</strong>: hort en funcionament</li>
<li><strong>Filosofia</strong>: ecològica, sense químics de síntesi</li>
</ul>
<h2 id="dades-de-reg-actualitzades-juny-2026">Dades de reg actualitzades (juny 2026)</h2>
<ul>
<li><strong>Reg</strong>: amb MÀNEGA (a baixa pressió)</li>
<li><strong>Mulching</strong>: NO encara (URGENT muntar aquesta setmana)</li>
<li><strong>Última pluja</strong>: avui 10/06/2026</li>
<li><strong>Sòl sorrenc</strong>: regar més sovint que en sòl argilós (l&#x27;aigua passa ràpid)</li>
</ul>
<h2 id="cultius-amb-mida-exacta-juny-2026">Cultius amb mida exacta (juny 2026)</h2>
<table>
<thead><tr>
<th>Cultiu</th>
<th>Plantes / m²</th>
<th>Superfície estimada</th>
</tr></thead><tbody>
<tr>
<td>Tomàquets</td>
<td>12 plantes</td>
...
<ol>
<li><strong>Tomàquets</strong> — varietat a anotar</li>
<li><strong>Pebrots</strong> — varietat a anotar</li>
<li><strong>Mongetes</strong> — varietat a anotar</li>
<li><strong>Enciams</strong> — varietat a anotar</li>
<li><strong>Pastanagues</strong> — varietat a anotar</li>
...
┌─────────────────────────────────────────────┐
│                                             │
│  20 m² dividits en ____ parcel·les          │
│                                             │
│  (fer dibuix o descriure)                   │
│                                             │
│                                             │
└─────────────────────────────────────────────┘
</code></pre>
...
<ul>
<li><strong>Hivern 2025-26</strong>: —</li>
<li><strong>Primavera 2026</strong>:</li>
<li>Trasplantament tomàquets/pebrots al maig: ✓</li>
<li>Altres plantacions:</li>
<li><strong>Estiu 2026</strong> (en curs):</li>
<li>Cultius actius: tomàquets, pebrots, mongetes, enciams, pastanagues, carbasses, carabassons</li>
<li>Tasques pendents: mulching, despuntar tomaqueres, sembrar cols d&#x27;hivern</li>
<li><strong>Tardor 2026</strong> (planificat):</li>
<li>Trasplantar cols, escaroles, enciams d&#x27;hivern</li>
<li>Sembrar alls</li>
<li>Adob verd hivernal (civada + veça)</li>
</ul>
